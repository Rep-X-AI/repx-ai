          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <a
                  href="#home"
                  className={`block px-3 rounded ${activeLink === "home"
                    ? "text-white hover:nav-gradient nav-gradient"
                    : "text-gray-400"
                    }`}
                  aria-current="page"
              ...
              <li>
                <a
                  href="#about"
                  className={`block px-3 rounded ${activeLink === "about"
                    ? "text-white hover:nav-gradient nav-gradient"
                    : "text-gray-400"
                    }`}
                  onClick={() => handleActiveLink("about")}
              ...
              <li>
                <a
                  href="#features"
                  className={`block px-3 rounded ${activeLink === "features"
                    ? "text-white hover:nav-gradient nav-gradient"
                    : "text-gray-400"
                    }`}
                  onClick={() => handleActiveLink("features")}
              ...
              <li>
                <a
                  href="#team"
                  className={`block px-3 rounded ${activeLink === "team"
                    ? "text-white hover:nav-gradient nav-gradient"
                    : "text-gray-400"
                    }`}
                  onClick={() => handleActiveLink("team")}
              ...
              <li>
                <a
                  href="#contact"
                  className={`block px-3 rounded ${activeLink === "contact"
                    ? "text-white hover:nav-gradient nav-gradient"
                    : "text-gray-400"
                    }`}
                  onClick={() => handleActiveLink("contact")}
