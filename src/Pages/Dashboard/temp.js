...
export default function temp({ role }) {
    ...
    <>
      <div className="w-full max-w-screen-lg mx-auto p-4">
        ...
        <>
          {isModalOpen && (
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none ">
              <div className="relative w-auto my-6 mx-auto max-w-3xl">
                {/* Modal content */}
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full  outline-none focus:outline-none bg-gradient-to-b from-purple-100 to-purple-400">
                  {/* Modal header */}
          ...
          <div className="bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 text-white p-6 rounded-lg shadow-lg mb-6">
            ...
            <p className="text-zinc-200">Teacher: { createdBy || currentUser.displayName}</p>
            <p className="text-zinc-200">Deadline: {new Date(selectedDate).toLocaleDateString("en-GB")}</p>
      ...
      {role === "teacher" && (
        <div className="bg-indigo-100 rounded-lg shadow-lg p-6 text-center mb-6">
          ...
          <p className="font-bold mb-4">Evaluate quickly with the power of AI</p>
          <Link to="/dashboard/evaluate" className="bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-purple-600 hover:to-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-400 inline-block">
            Evaluate Now!
          </Link>
        </div>
      )}
