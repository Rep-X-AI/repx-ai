...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-t from-indigo-950 to-slate-900 min-h-screen flex flex-col items-center justify-center">
        <div className="bg-gradient-to-t jff from-purple-300 to-purple-100 p-8 rounded shadow-md w-96">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              disabled={loading}
              className="w-full bg-indigo-700 hover:bg-indigo-800 duration-75 text-white p-2 rounded"
              type="submit"
            >
              Log In
            </button>
        ...
        <div className="text-center text-white mt-4">
          Need an account?{" "}
          <Link to="/signup" className="text-purple-300 font-bold tracking-wide">
            Sign Up
          </Link>
        </div>
      </div>
