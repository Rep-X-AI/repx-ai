...
const NotFound = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-black" style={{ backgroundImage: `url(/matrix.webp)`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', }}>
